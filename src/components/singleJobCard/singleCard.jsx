...
const SingleJob = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useSelector((state) => state.singleCard);
    ...
    <>
      <div className="single-job-container">
        ...
        <div className="job-description">
          ...
          <h5 className="mb-1">
            Need {data?.jobRole || "Associate Software Developer"}
          </h5>
          <hr />
          <img
            src={data?.coverPhoto}
      ...
      <div className="single-job-container job-description row">
        ...
        <div style={{ marginTop: "30px" }}>
          ...
          <p>
            {" "}
            <li> {data?.appyInstructions} </li>
          </p>
        </div>

        <ShareableLinks
          url={`https://jobhuntings.developnators.com/${data?.jobId}`}
          title="Check out this amazing Job!"
        />
        <hr />
        <div
          style={{
        ...
        >
          <h4>
            {" "}
            Interested in this job? <br />
            <strong>Apply ASAP</strong>{" "}
          </h4>
          <div>
            {data?.appyLink ? (
              <a
